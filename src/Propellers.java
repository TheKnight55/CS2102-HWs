public class Propellers {
    ...
    /**
     * Multiplies the seconds by the collective static current drawn by the propellers (mA-s/mA)
     * @param secondsRunFor batteryLeft on this battery (mA-s)
     * @return the total amount of battery spent by the unit
     */
